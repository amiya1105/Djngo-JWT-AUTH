...
SECRET_KEY = 'django-insecure-!dt0=x^*e*it&mf+#nlabs*mik^hys^9-1o=+)zx$i3ur&f5wl'
...
EMAIL_PORT=587
# EMAIL_HOST_USER='peaceamiyakumardash@gmail.com'
EMAIL_HOST_USER=os.environ.get('EMAIL_USER')
# EMAIL_HOST_PASSWORD='xbqszxdggkaaafta'
